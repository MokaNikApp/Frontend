  ...
  return (
    <div>
        ...
        <div className="space-y-4 text-sm">
            ...
            <div>
                <p className="font-medium">Sarah Miller requested a service</p>
            ...
            <div>
                <p className="font-medium">Payment of $125.00 received</p>
            ...
            <div>
                <p className="font-medium">New 5-star review from James W.</p>
            ...
            <div>
                <p className="font-medium">Message from Auto Parts Co.</p>
        ...
        <button className="w-full mt-4 bg-gray-100 py-2 rounded text-sm">
            View All Activity
        </button>
