    ...
    <section className="px-6 lg:px-24">
      ...
      <div className="flex flex-wrap gap-4 justify-between">
        {categories.map((cat, i) => (
          <button
            key={i}
            className="flex items-center gap-2 px-8 py-4 rounded-sm border shadow-lg border-gray-300 text-sm text-gray-700 hover:bg-blue-700 hover:text-white transition"
          >
