...
export default function ServiceHero() {
  ...
  return (
    <section className="px-6 lg:px-24 py-10 lg:py-12">
      ...
      {/* IMAGE + CARD */}
      <div className="grid lg:grid-cols-3 gap-8 lg:gap-10 mt-10 items-start">
        ...
        <div className="lg:col-span-2">
          <img
            ...
            className="w-full h-62.5 sm:h-87.5 lg:h-105 object-cover rounded-xl"
          />
        </div>

        {/* BOOKING CARD */}
        <div className="bg-white shadow-lg rounded-xl p-5 sm:p-6 border w-full">
          ...
          <div className="mt-6">
            ...
            <div className="flex mt-1 rounded-lg bg-gray-100 items-center px-3">
          ...
          <div className="mt-4">
            ...
            <div className="flex mt-1 rounded-lg bg-gray-100 items-center px-3">
              <FiCalendar className="text-gray-400 text-lg mr-2" />
              <input
                type="text"
          ...
          <div className="text-xs text-gray-500 space-y-3">
            <p className="flex items-center">
              <FaShieldAlt className="text-green-400 text-lg mr-2" />
              Secure booking protection
            </p>

            <p className="flex items-center">
              <FaHeadset className="text-green-400 text-lg mr-2" />
      ...
      <section className="mt-10">
        <h2 className="text-lg sm:text-xl text-slate-800 mb-4 font-semibold">
          About this Service
        </h2>

        <p className="text-gray-500 leading-relaxed text-sm sm:text-base lg:pr-24">
