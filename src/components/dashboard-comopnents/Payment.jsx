...
//             <p className="text-sm text-green-600">Excellent Across 3 gateways</p>
//           </div>
//         </div>
//       </div>
...
//         {activeTab === "Invoices" && (
//           <div>
//             <p>Invoices table content goes here.</p>
//           </div>
//         )}
...
//   HiOutlineStar,
// } from "react-icons/hi";
// import { FaFileAlt, FaCreditCard, FaFileInvoiceDollar } from "react-icons/fa";
...
//       {/* Tab Content */}
//       <div className="lg:col-span-2 p-4 sm:p-6 bg-white shadow-md rounded-xl space-y-5 mt-4">
...
//                 <FaFileInvoiceDollar size={24} className="text-blue-500" />
//                 <div>
//                   <p>Invoice #1234</p>
//                   <p>Paid • $450.00</p>
//                 </div>
