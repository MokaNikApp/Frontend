...
//     return tab === "unread" ? data.filter((n) => n.unread) : data;
//   };
...
//     // Here you can replace with real functionality
//   };
...
//       className="flex items-start gap-4 p-4 bg-white border border-gray-100 shadow-sm rounded-xl hover:shadow-md hover:scale-[1.01] transition-all"
//     >
//       {/* Icon */}
//       <div className="relative w-10 h-10 flex items-center justify-center bg-gray-50 rounded-lg">
//         {getIcon(note.type)}
//         {note.unread && (
...
//       {/* Time */}
//       <div className="text-gray-400 text-xs whitespace-nowrap">{note.time}</div>
//     </motion.div>
//   );
...
//               {filterData(today).map(renderCard)}
//             </div>
//           </AnimatePresence>
//         </div>
//       )}
...
//           <AnimatePresence>
//             <div className="space-y-3">
//               {filterData(yesterday).map(renderCard)}
//             </div>
//           </AnimatePresence>
//         </div>
//       )}
