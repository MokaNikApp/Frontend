...
//       {/* Service Card */}
//       <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-300 space-y-4">
        
//         {/* Top Image */}
//         <img src={pic2} alt="service" className="w-full rounded-lg" />
...
//           <div>
//             <p className="font-semibold text-gray-800">Full Engine Diagnostics & Tune-up</p>
//             <p className="text-sm text-gray-500">2021 Toyota Camry Hybrid • Silver</p>
//           </div>
//           <div>
//             <p className="text-sm font-medium text-gray-700">Today, 4:30 PM</p>
//           </div>
//         </div>
...
//             <div className="bg-[#1C52AF] h-2 rounded-full" style={{ width: "65%" }}></div>
//           </div>
//         </div>
...
//             <div>
//               <p className="text-xs text-gray-500">Mechanic Assigned</p>
...
//         {/* Top Image */}
//         <img src={pic3} alt="service" className="w-full rounded-lg" />
...
//         <div className="flex justify-between items-start">
//           <div>
//             <p className="font-semibold text-gray-800">Brake Pad Replacement & Rotor Polish</p>
//             <p className="text-sm text-gray-500">2019 Tesla Model 3 • Deep Sea Blue</p>
//           </div>
//           <div>
//             <p className="text-sm font-medium text-gray-700">Tomorrow, 9:00 AM</p>
//           </div>
//         </div>
...
//         {/* Top Image */}
//         <img src={pic4} alt="service" className="w-full rounded-lg" />
